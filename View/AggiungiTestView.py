...
class AggiungiTestView(object):
    def setupUi(self, MainWindow):
        ...
        self.Title.setGeometry(QtCore.QRect(130, 200, 631, 121))
        font = QtGui.QFont()
        ...
        self.labelVirgola = QtWidgets.QLabel(self.centralwidget)
        self.labelVirgola.setGeometry(QtCore.QRect(135, 365, 631, 121))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.labelVirgola.setFont(font)
        self.labelVirgola.setAcceptDrops(False)
        self.labelVirgola.setObjectName("labelVirgola")

        self.labelSpazi = QtWidgets.QLabel(self.centralwidget)
        self.labelSpazi.setGeometry(QtCore.QRect(135, 300, 631, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.labelSpazi.setFont(font)
        self.labelSpazi.setAcceptDrops(False)
        self.labelSpazi.setObjectName("labelSpazi")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Title.setText(_translate("MainWindow", "Aggiungi un nuovo Test!"))
        self.contenutoTextInput.setPlainText(_translate("MainWindow", ""))
        self.labelVirgola.setText(_translate("MainWindow", "Ricordati di separare ogni parola con il carattere ,"))
        self.labelSpazi.setText(_translate("MainWindow", "Tutti gli spazi in eccesso verrano rimossi, inoltre il contenuto del test verrà randomizzato ogni volta che viene eseguito!"))
